...
public class EnglishSemanticPanel extends LeafEditorPanel{
            ...
            public void valueChanged(ListSelectionEvent listSelectionEvent) {
                if (!listSelectionEvent.getValueIsAdjusting()) {
                    if (list.getSelectedIndex() != -1 && previousNode != null) {
                        ...
                        LayerAction action = new LayerAction(((EnglishSemanticPanel)((JList) listSelectionEvent.getSource()).getParent().getParent().getParent()), previousNode.getLayerInfo(), ((SynSet) list.getSelectedValue()).getId(), ViewLayerType.ENGLISH_SEMANTICS);
