...
public class TreeTraverseProcessedFrame extends TreeTraverseFrame {

    protected JMenu traverseMenu, viewMenu;

    public TreeTraverseProcessedFrame(FsmMorphologicalAnalyzer fsm, TreeBankDrawable traverseBank){
