...
public abstract class TreeTraverseFrame extends TreeStructureEditorFrame {
    ...
    protected TreeViewerPanel viewer;
    ...
    public TreeTraverseFrame(FsmMorphologicalAnalyzer fsm, TreeBankDrawable traverseBank){
        this.fsm = fsm;
