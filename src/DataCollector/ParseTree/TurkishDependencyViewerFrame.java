...
public class TurkishDependencyViewerFrame extends DataCollector{

    public TurkishDependencyViewerFrame(){
        JButton button;
        ...
        itemOpen.addActionListener(e -> {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                TurkishDependencyViewerPanel turkishDependencyViewerPanel = new TurkishDependencyViewerPanel(fcinput.getSelectedFile().getAbsolutePath());
    ...
    private void nextSentence(int count){
        TurkishDependencyViewerPanel current = (TurkishDependencyViewerPanel) ((JScrollPane) projectPane.getSelectedComponent()).getViewport().getView();
        if (current != null){
