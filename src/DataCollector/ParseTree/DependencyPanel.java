...
public class DependencyPanel extends EditorPanel {
    ...
    public DependencyPanel(String path, String fileName) {
            ...
            public void valueChanged(ListSelectionEvent listSelectionEvent) {
                if (!listSelectionEvent.getValueIsAdjusting()) {
                    if (list.getSelectedIndex() != -1 && fromNode != null && draggedNode != null) {
                        ...
                        LayerAction action = new LayerAction(((DependencyPanel)((JList) listSelectionEvent.getSource()).getParent().getParent().getParent()), fromNode.getLayerInfo(), relation, ViewLayerType.DEPENDENCY);
